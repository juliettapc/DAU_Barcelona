...
def main():
    ...
    type_strategists="weirdos"  #  altruists   rationals   mostly_def    weirdos
    ...
    output_filename1="../Results/Cooperation_TSplane_"+str(type_strategists)+".dat"
    output1= open(output_filename1,'wt')


    output_filename2="../Results/SEM_cooperation_TSplane_"+str(type_strategists)+".dat"
