...
def main():
    ...
    cont=0
    for item in  itertools.combinations(list_files, 2):
        ...
        if region1 != region2:
            ...
            intersection=float(len(list(set(list1)& set(list2))))
            min_size=float(min([len(list1),len(list2)]))
...
#            if percent >=75. or intersection >=100:
                ...
                for i in range(1000):
                    ...
                    random_intersection=float(len(list(set(random_list1)& set(random_list2))))
                    list_random_intersection.append(random_intersection)

                    random_min_size=float(min([len(random_list1),len(random_list2)]))
